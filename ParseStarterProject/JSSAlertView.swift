...
class JSSAlertView: UIViewController {
   ...
   // var emailtextfield:UITextField!
    ...
    func show(viewController: UIViewController, title: String, text: String?=nil, buttonText: String?=nil, cancelButtonText: String?=nil, color: UIColor?=nil, iconImage: UIImage?=nil) -> JSSAlertViewResponder {
      ...
      //  self.rootViewController.addChildViewController(self)
        ...
        viewController.view.addSubview(view)  //my stuff
        
       // self.view.backgroundColor = UIColorFromHex(0x31797D, alpha: 0.8)
        
        self.view.backgroundColor = UIColorFromHex(0x000000, alpha: 0.5)
       // self.view.layer.cornerRadius = 20 // MY STUFF!
        ...
        let textColor = self.lightTextColor//darkTextColor
       ...
       /* if let textfield = textfield {
            ...
            emailtextfield.font = UIFont(name: self.textFont, size: 16)
            emailtextfield.backgroundColor = UIColor.clearColor()
            emailtextfield.text = ""
            emailtextfield.placeholder = "Type email of receiver"
    ...
    */
    ...
    /// My STUFF
  //  func addEmailAction(action: ()->Void) { // NO NEED TO DO THAT
   //     self.closeAction = action
   // }
    ...
    func closeView(withCallback:Bool, source:ActionType = .Close) {
        UIView.animateWithDuration(0.3, delay: 0, usingSpringWithDamping: 0.7, initialSpringVelocity: 0.5, options: .CurveEaseInOut, animations: {
    ...
    func removeView() {
        isAlertOpen = false
        self.removeFromParentViewController() //I decided to delete this
       
        self.view.removeFromSuperview()//I decided to delete this
